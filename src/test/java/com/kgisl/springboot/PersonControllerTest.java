...
import com.kgisl.springboot.Controller.PersonController;
...
public class PersonControllerTest {
    ...
    public void getPerson() {
        Long id = 1l;
        when(personService.getPerson(id)).thenReturn(person1);
    ...
    public void updatePersonTest() {
        ...
        Person updatedperson = new Person(1l, "yogesh", "yogesh.gmail.com");
        Long id = 1l;
    ...
    public void insertPerson() {
        ...
        ResponseEntity<Person> actual = personController.insertPerson(person1);
        assertNotNull(actual);
